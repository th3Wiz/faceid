...
<head>
    ...
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="../theme/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
...
<body class="skin-default fixed-layout">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <img src="../theme/dist/img/logo.png" class="light-logo" alt="homepage" width="80%"/>
                     </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../theme/assets/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down">{{Session::get('user')['name']}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="../theme/assets/images/users/1.jpg" alt="user-img" class="img-circle"><span class="hide-menu">{{Session::get('user')['username']}}</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="javascript:void(0)"><i class="ti-settings"></i> Account Setting</a></li>
                                <li><a href="javascript:void(0)"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('admin/home')}}" aria-expanded="false"><i class="icon-speedometer"></i>Dashboard</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{route('admin/person')}}" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Person</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('logout')}}" aria-expanded="false"><i class="far fa-circle text-success"></i><span class="hide-menu">Log Out</span></a></li>
                    </ul>
                </nav>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">IDENTIFIED PEOPLE</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-success">150</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 85%; height: 6px;" aria-valuenow="150" aria-valuemin="0" aria-valuemax="200"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="icon-user-unfollow"></i></h3>
                                            <p class="text-muted">UNKNOWN PEOPLE</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-primary">50</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="progress">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 85%; height: 6px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="200"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="icon-camera"></i></h3>
                                            <p class="text-muted">CAMERA</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-purple">200</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="progress">
                                        <div class="progress-bar bg-purple" role="progressbar" style="width: 85%; height: 6px;" aria-valuenow="200" aria-valuemin="0" aria-valuemax="250"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="icon-location-pin"></i></h3>
                                            <p class="text-muted">LOCATION</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-cyan">100</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="progress">
                                        <div class="progress-bar bg-cyan" role="progressbar" style="width: 85%; height: 6px;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="120"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="../theme/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap popper Core JavaScript -->
    <script src="../theme/assets/node_modules/popper/popper.min.js"></script>
    <script src="../theme/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="../theme/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    ...
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="../theme/assets/node_modules/raphael/raphael-min.js"></script>
    <script src="../theme/assets/node_modules/morrisjs/morris.min.js"></script>
    <script src="../theme/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Popup message jquery -->
    <!-- Chart JS -->
    <script src="../theme/dist/js/dashboard1.js"></script>
    <div id="map"></div>
    <script>
      var map, heatmap;
      function initMap() {
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8Rng4CBtMc08vjgiwcFFwA1zwB8SL09I&libraries=visualization&callback=initMap">
    </script>
</body>
